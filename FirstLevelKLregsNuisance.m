function FirstLevelKLregsNuisance(cfg)
% function FirstLevelKLregsNuisance(cfg)
% e.g
% cfg = []; 
...
for sub = 1:nsubjects
    ...
    if ~exist(fullfile(FLdir,'SPM.mat'),'file')
        ...
        for sess = 1:nSess
            ...
            reg = 1;
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).name = 'Target';
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).onset = regressors.onsets;
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).duration = regressors.durations;
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).tmod = 0;
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).pmod(1).name = 'KL_W';
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).pmod(1).param = regressors.pmod{1};
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).pmod(1).poly = 1;
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).pmod(2).name = 'KL_A';
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).pmod(2).param = regressors.pmod{2};
            specification{1}.spm.stats.fmri_spec.sess(sess).cond(reg).pmod(2).poly = 1;
